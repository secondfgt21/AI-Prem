...
.drawer-backdrop,.chat-backdrop,.skeleton-screen{position:fixed;inset:0;display:none}.drawer-backdrop.show,.chat-backdrop.show,.skeleton-screen.show{display:block}.drawer-backdrop,.chat-backdrop{background:rgba(0,0,0,.55);z-index:1250}.drawer{position:fixed;left:0;top:0;bottom:0;width:min(88vw,320px);transform:translateX(-100%);transition:transform .24s ease;z-index:1260;padding:18px;background:linear-gradient(180deg, rgba(8,8,11,.98), rgba(8,8,11,.94));border-right:1px solid rgba(255,255,255,.08)}.drawer.show{transform:translateX(0)}.drawer a{display:block;padding:14px 14px;border-radius:14px;margin-top:10px;text-decoration:none;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08)}
...
.skeleton-screen{z-index:1300;background:linear-gradient(180deg, rgba(4,4,5,.96), rgba(7,7,10,.98));padding:20px}.sk-wrap{width:min(720px, 100%);margin:40px auto}.sk{border-radius:16px;background:linear-gradient(90deg, rgba(255,255,255,.08), rgba(255,255,255,.15), rgba(255,255,255,.08));background-size:200% 100%;animation:sh 1.1s infinite linear}@keyframes sh{to{background-position:-200% 0}}
...
<div id="skeletonCheckout" class="skeleton-screen"><div class="sk-wrap"><div class="sk" style="height:28px;width:220px;margin-bottom:18px"></div><div class="sk" style="height:180px;width:100%;margin-bottom:18px"></div><div class="sk" style="height:22px;width:70%;margin-bottom:10px"></div><div class="sk" style="height:22px;width:55%;margin-bottom:10px"></div><div class="sk" style="height:52px;width:100%;margin-top:18px"></div></div></div>
...
function showSkeletonAndGo(url){document.getElementById('skeletonCheckout').classList.add('show');setTimeout(()=>{window.location.href=url;},450);}
